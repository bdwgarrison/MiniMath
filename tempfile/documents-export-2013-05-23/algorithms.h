...
//Aitken's method is a "method accelerator" and not a method itself. It takes a linearly convergent method and turns it into a faster one. Therefore the fnc::function argument must be a linearly convergent fixed point iterative method.
int aitken1d (fnc::function*, double* domain, int unsigned maxit, double tol, double* root);

//Stephenson's method is a "method accelerator" and not a method itself. It takes a linearly convergent method and turns it into a quadratically convergent one. Therefore the fnc::function argument must be a linearly convergent fixed point iterative method.
int steffenson1d (fnc::function*, double* domain, int unsigned maxit, double tol, double* root);
